...
function FinancialItemModal({
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={handleClose}
            title={`${initialData ? 'Edit' : 'Add'} ${category === 'liabilities' ? 'Liability' : category.slice(0, -1)} Item`}
            description={initialData ? 'Update the details of this item.' : `Add a new item to your ${category}.`}
        >
